...
def send_photo(message):
    photo_rasp = open('/bot/pfpgups/tmp/rasp.png', 'rb')
...
def send_photo_changes(message):
    ...
    driver.save_screenshot('/bot/pfpgups/tmp/changes.png')
    ...
    photo_part1 = open('/bot/pfpgups/tmp/changes_part1.png', 'rb')
    bot.send_photo(message.chat.id, photo_part1)
    photo_part2 = open('/bot/pfpgups/tmp/changes_part2.png', 'rb')
